...
if __name__ == '__main__':
    ...
    analyzed_pairs_dict_avg = osp.analyze_pairs(important_l, fixed_col='time', p_value=0.05, only_avg=True,
                                                data_path=data_set_path)
    analyzed_pairs_dict_full = osp.analyze_pairs(important_l, fixed_col='time', p_value=0.05, only_avg=False,
                                                 data_path=data_set_path)
